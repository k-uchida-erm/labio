npm warn exec The following package was not found and will be installed: supabase@2.72.7
    ...
    Tables: {
      ...
      activity_status_events: {
        Row: {
          ...
          created_at: string
          from_status: Database["public"]["Enums"]["activity_status"]
          id: string
          operation_id: string
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "activity_status_events_operation_id_fkey"
            columns: ["operation_id"]
            isOneToOne: false
            referencedRelation: "activity_status_operations"
            referencedColumns: ["id"]
          },
        ]
      }
      activity_status_operations: {
        Row: {
          actor_id: string | null
          created_at: string
          id: string
